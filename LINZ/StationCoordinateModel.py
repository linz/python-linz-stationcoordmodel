...
def main():
    ...
    parser.add_argument('-f','--model-file',default='{code}.xml',help="File name for model")
    ...
    parser.add_argument('-a','--update_availability',action='store_true',help='Load timeseries, update availability')
    parser.add_argument('-c','--clear_availability',action='store_true',help='Remove availability information from model')
    parser.add_argument('-l','--clear_covariance',action='store_true',help='Remove covariance information from model')
    parser.add_argument('-q','--quiet',action='store_true',help='Don''t print the model by default')
